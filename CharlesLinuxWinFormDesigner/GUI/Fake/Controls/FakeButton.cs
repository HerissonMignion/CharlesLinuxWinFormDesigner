...
{
    public class FakeButton : FakeControl
    {

        public FakeButton() : base()
        {
            this.ClassName = "Button";
            this.ListProperties.Add(new FakeProperty("TextAlign", typeof(ContentAlignment), ContentAlignment.MiddleCenter, this));
        }
